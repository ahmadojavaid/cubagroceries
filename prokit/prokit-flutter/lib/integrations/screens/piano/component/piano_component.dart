...
import 'package:prokit_flutter/integrations/screens/piano/component/key.dart';
import 'package:prokit_flutter/integrations/screens/piano/component/octave.dart';
    ...
    return SizedBox(
      ...
      child: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          return Row(
            children: [
              for (final widgets in octaves.mapIndexed(
                (index, element) => [
                  OctaveWidget(
