          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: textPrimary("read", color: textPrimaryColor, size: 20),
              ),
              SizedBox(height: 10),
              Padding(
                padding: EdgeInsets.only(left: 16, right: 16),
                child: Text(sentences, style: secondaryTextStyle()),
              ),
              SizedBox(height: 20),
            ],
          ),
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: text("view", fontSize: 18, textColor: textPrimaryColor, maxLine: 2),
              ),
              Divider(),
              Padding(
