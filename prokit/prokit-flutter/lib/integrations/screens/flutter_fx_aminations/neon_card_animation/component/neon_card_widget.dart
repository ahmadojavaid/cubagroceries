...
class NeonCardWidget extends StatefulWidget {
  final Widget child;
  ...
  @override
  _NeonCardWidgetState createState() => _NeonCardWidgetState();
}

class _NeonCardWidgetState extends State<NeonCardWidget> with SingleTickerProviderStateMixin {
...
class GlowRectanglePainter extends CustomPainter {
  ...
  bool shouldRepaint(GlowRectanglePainter oldDelegate) {
    return oldDelegate.progress != progress || oldDelegate.intensity != intensity || oldDelegate.glowSpread != glowSpread;
  }
}
