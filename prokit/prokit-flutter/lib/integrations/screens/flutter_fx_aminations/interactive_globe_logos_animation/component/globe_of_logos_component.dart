...
class GlobeOfLogosComponent extends StatefulWidget {
  final List<IconData> icons;
  final double radius;
  final Color defaultIconColor;

  const GlobeOfLogosComponent({
    Key? key,
    required this.icons,
    this.radius = 150.0,
  ...
  @override
  State<GlobeOfLogosComponent> createState() => _GlobeOfLogosComponentState();
}

class _GlobeOfLogosComponentState extends State<GlobeOfLogosComponent> with SingleTickerProviderStateMixin {
  ...
  void _performAutoRotation() {
    ...
    if (_lastInteractionTime != null) {
      ...
      if (timeSinceInteraction.inMilliseconds < 500) return; // Wait for interaction to settle
    }
