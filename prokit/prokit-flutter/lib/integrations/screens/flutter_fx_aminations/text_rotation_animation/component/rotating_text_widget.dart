...
class _CircularTextPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int rep = 0; rep < repetitions; rep++) {
      ...
      for (int i = 0; i < text.length; i++) {
        ...
        textPainter.paint(canvas, Offset(-charWidths[i] / 2, -textPainter.height / 2));
  ...
  void _drawDot(Canvas canvas, double centerX, double centerY, double angle, double radius) {
