...
class BorderBeamWidget extends StatefulWidget {
  final Widget child;
  ...
  @override
  _BorderBeamWidgetState createState() => _BorderBeamWidgetState();
}

class _BorderBeamWidgetState extends State<BorderBeamWidget> with SingleTickerProviderStateMixin {
...
class BorderBeamPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.shader = ui.Gradient.linear(
      ...
      gradientEnd,
      [
        colorTo.withValues(alpha: 0.0), // Transparent color for fading effect
        colorTo,
        colorFrom,
      ],
      [0.0, 0.3, 1.0],
