      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: Get.height * 0.016),
            Text('Price Range', style: TextStyle(color: appStore.isDarkModeOn ? white : black, fontSize: 16, fontWeight: FontWeight.w600)).paddingSymmetric(horizontal: 8),
            SizedBox(height: Get.height * 0.016),
            Obx(
              () => RangeSlider(
                min: 1,
            ...
            SizedBox(height: Get.height * 0.016),
            Text('Sort by', style: TextStyle(color: appStore.isDarkModeOn ? white : black, fontSize: 16, fontWeight: FontWeight.w600)).paddingSymmetric(horizontal: 8),
            SizedBox(height: Get.height * 0.016),
            SingleChildScrollView(
              scrollDirection: Axis.horizontal,
              child: Obx(
            ...
            SizedBox(height: Get.height * 0.016),
            Text('Rating', style: TextStyle(color: appStore.isDarkModeOn ? white : black, fontSize: 16, fontWeight: FontWeight.w600)).paddingSymmetric(horizontal: 8),
            SizedBox(height: Get.height * 0.016),
            SingleChildScrollView(
              scrollDirection: Axis.horizontal,
              child: Obx(
