        ...
        return <Widget>[
          SliverAppBar(
            ...
            title: Row(
              ...
              children: [
                Text('Hello, John', style: boldTextStyle(color: white, size: 24)).paddingOnly(left: 16, right: 16, bottom: 16),
                IconButton(
                    onPressed: () {
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Column(
                ...
                children: <Widget>[
                  Text('Your Location', style: primaryTextStyle(color: white)).paddingOnly(left: 16, right: 16, top: 16),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      RichText(
