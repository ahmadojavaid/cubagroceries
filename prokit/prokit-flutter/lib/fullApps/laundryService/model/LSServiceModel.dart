...
List<LSServiceModel> getTopServiceList() {
  ...
  list.add(LSServiceModel(title: 'Wash & Iron', img: LSSweatshirt));
...
List<LSServiceModel> getNearByServiceList() {
  ...
  list.add(LSServiceModel(title: 'Local Laundry', rating: '5', location: '1810,Camino Real ,New-york', img: LSList1));
...
List<LSServiceModel> getBookingList() {
  ...
  list.add(LSServiceModel(title: 'Local Laundry', amount: '474', status: 'confirmed', orderNo: '1235786535', date: 'Wed, 15 June 2019, 11:35AM', location: '1810,Camino Real ,New-york'));
  ...
  list.add(LSServiceModel(title: 'Local Laundry', amount: '342', status: 'Delivered', orderNo: '1234234565', date: 'Sat, 05 Aug 2019, 1:05PM', location: '1810,Camino Real ,New-york'));
