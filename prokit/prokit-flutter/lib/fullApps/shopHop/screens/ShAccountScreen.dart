                ...
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      // Spacer(),
                      SizedBox(width: 22,),
                      Expanded(child: Marquee(direction: Axis.horizontal,child: Text(sh_lbl_please_verify_your_email_or_number,overflow: TextOverflow.visible, style: primaryTextStyle()))),
