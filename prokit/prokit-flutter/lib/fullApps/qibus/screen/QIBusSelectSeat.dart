      ...
      children: <Widget>[
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(color: qIBus_colorPrimary,borderRadius: BorderRadius.circular(16)),
            height: context.height(),
            width: context.width(),
            margin: EdgeInsets.all(16),
            padding: EdgeInsets.only(top: spacing_middle, bottom: spacing_middle),
            child: Center(child: text("Confirm The Seats", textColor: qIBus_white, fontFamily: fontMedium, isCentered: true)),
          ),
        ).expand()
      ],
    ),
