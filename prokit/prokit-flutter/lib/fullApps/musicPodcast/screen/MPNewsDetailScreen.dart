            ...
            Column(
              children: [
                Row(
                  ...
                  children: [
                    Text("Whispers of Hidden Echoes", style: boldTextStyle(color: white.withOpacity(0.9))),
                    Icon(
                ...
                16.height,
                Text(news_paragraph, style: secondaryTextStyle(color: mpAppTextColor1, size: 14)),
                16.height,
                Text(news_paragraph, style: secondaryTextStyle(color: mpAppTextColor1, size: 14)),
                16.height,
                Text(news_paragraph, style: secondaryTextStyle(color: mpAppTextColor1, size: 14)),
