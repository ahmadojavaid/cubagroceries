                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: Stack(
                      children: [
                        InkWell(
                          onTap: () => print(cookingmodel[index].data),
                          child: ClipRRect(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: Row(
                                      children: [
                                        CircleAvatar(
                                          radius: 15,
                                          child: ClipOval(child: commonCachedNetworkImage(cookingmodel[index].chefpic.toString(), fit: BoxFit.cover, height: 60, width: 60)),
                                        ),
                                        SizedBox(width: 8),
                                        Text(
                                          cookingmodel[index].chefname.toString(),
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    height: 70,
                                    child: Text(cookingmodel[index].data.toString(), style: TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.w800)),
                                  ),
                                ),
