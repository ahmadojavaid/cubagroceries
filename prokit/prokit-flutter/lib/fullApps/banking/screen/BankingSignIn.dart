        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              16.height,
              EditText(text: "Phone", isPassword: false, keyboardType: TextInputType.number),
              8.height,
              EditText(text: "Password", isPassword: true, isSecure: true, keyboardType: TextInputType.text),
              16.height,
              Align(
