      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("The new product launch has generated significant excitement among consumers, with pre-orders exceeding expectations.", textAlign: TextAlign.center, style: secondaryTextStyle())
                .paddingAll(8),
          ],
        ),
      ),
