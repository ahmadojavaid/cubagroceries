...
import 'package:prokit_flutter/integrations/screens/animation_to/animation_home.dart';
...
import 'package:prokit_flutter/integrations/screens/compass/screen/compass_screen.dart';
...
import 'package:prokit_flutter/integrations/screens/piano/piano_home_screen.dart';
...
import '../../fullApps/athleto/screens/athleto_splash_screen.dart';
...
import '../../fullApps/stayNest/screen/staynest_splash_screen.dart';
import '../../fullApps/villaVerse/screens/villa_verse_splash.dart';
import '../../integrations/screens/audioPicker/audio_picker.dart';
import '../../integrations/screens/carousel_view_slider/carousel_view_slider_screen.dart';
import '../../integrations/screens/flutter_fx_aminations/blur_fade_animation/blur_fade_example.dart';
import '../../integrations/screens/flutter_fx_aminations/border_beam_animation/border_beam_home_screen.dart';
import '../../integrations/screens/flutter_fx_aminations/circle_selector_animation/circle_selector_animation_screen.dart';
import '../../integrations/screens/flutter_fx_aminations/interactive_globe_logos_animation/tech_3d_cloud_demo_screen.dart';
import '../../integrations/screens/flutter_fx_aminations/neon_card_animation/neon_card_demo_screen.dart';
import '../../integrations/screens/flutter_fx_aminations/text_rotation_animation/text_rotate_demo_screen.dart';
import '../../integrations/screens/material_3/material_3_screen.dart';
import '../../integrations/screens/water_fx_effect_screen.dart';
...
Future<AppTheme> getAllAppsAndThemes({String? route}) async {
  ...
  appTheme.flutterFxAnimations = getFlutterFxAnimations();
  ...
  if (route != null) {
    ...
    } else if (route.validate() == ProKitLauncher.flutterFxAnimationsTag) {
      push(ProKitScreenListing(appTheme.flutterFxAnimations));
    }
  }
  return appTheme;
}
...
ProTheme getDashboards() {
  ...
  List<ProTheme> list = [];
  list.add(ProTheme(name: 'Weather Dashboard', tag: 'New',widget: WeatherDashboardScreen()));
  list.add(ProTheme(name: 'Health Dashboard', tag: 'New', widget: HealthAppHomeScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Streamit Dashboard', tag: 'New', widget: StreamItHome()));
  list.add(ProTheme(name: 'KiviCare Dashboard', tag: 'New', widget: KiviCareHomeScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Handyman Dashboard', tag: 'New', widget: HandyManDashBoard(), darkThemeSupported: true));
  list.add(ProTheme(name: 'KiviLabs Dashboard', tag: 'New', widget: KiviLabHomeScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Frezka Dashboard', tag: 'New', widget: FrezkaHomeScreen(), darkThemeSupported: true));
...
ProTheme getFullApps() {
  ...
  List<ProTheme> list = [];
  list.add(ProTheme(name: 'VillaVerse', tag: 'New', widget: VillaVerseSplashScreen()));
  list.add(ProTheme(name: 'StayNest', tag: 'New', widget: StayNestSplashScreen()));
  list.add(ProTheme(name: 'Athleto', tag: 'New', widget: AthletoSplashScreen()));
  ...
  list.add(ProTheme(name: 'Potea', tag: '', widget: PoteaSplashScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Adoptify', tag: '', widget: AdoptifySplashscreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Scribblr', tag: '', widget: ScribblrSplashScreen(), darkThemeSupported: true));
...
ProTheme getWorkingApps() {
  ProTheme theme = ProTheme(name: "Working Modules", tag: '', show_cover: true, sub_kits: []);
...
ProTheme getFlutterFxAnimations() {
  List<ProTheme> list = [];

  list.add(ProTheme(name: 'Circle Selector Animation', tag: '', widget: CircleSelectorHomeWidget(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Blur Fade Animation', tag: '', widget: BlurFadeExample(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Border Beam Animation', tag: '', widget: BorderBeamHomeScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Neon Card Animation', tag: '', widget: NeonGradientCardDemoScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Text Rotation Animation', tag: '', widget: TextRotateDemoScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Interactive Globe Logos Animation', tag: '', widget: Tech3dCloudStackDemoScreen(), darkThemeSupported: true));

  return ProTheme(name: 'FlutterFX Animations', title_name: 'FlutterFX Animations', tag: 'New', type: '', show_cover: false, sub_kits: list);
}
...
ProTheme getIntegrations({String? route}) {
  List<ProTheme> list = [];
  list.add(ProTheme(name: 'Animations', title_name: 'Integrations', show_cover: false, widget: AnimationHome(), darkThemeSupported: true, tag: 'New'));
  list.add(ProTheme(name: 'Compass', title_name: 'Integrations', show_cover: false, widget: CompassScreen(), darkThemeSupported: true, tag: 'New'));
  list.add(ProTheme(name: 'Piano', title_name: 'Integrations', show_cover: false, widget: PianoHomeScreen(), darkThemeSupported: true, tag: 'New'));
  list.add(ProTheme(name: 'Material 3', title_name: 'Integrations', show_cover: false, widget: Material3Screen(), darkThemeSupported: true, tag: 'New'));
  list.add(ProTheme(name: 'CarouselView Slider', title_name: 'Integrations', show_cover: false, widget: CarouselViewSliderScreen(), darkThemeSupported: true, tag: 'New'));
  list.add(ProTheme(name: 'WaterFx Effect', title_name: 'Integrations', show_cover: false, widget: WaterFxEffectScreen(), darkThemeSupported: true, tag: 'New'));
  list.add(ProTheme(name: 'FlutterFX Animations', title_name: 'Integrations', show_cover: false, sub_kits: getFlutterFxAnimationList(), darkThemeSupported: true, tag: 'New'));
  ...
  return ProTheme(name: 'Integrations', title_name: 'Integration', tag: 'New', type: '', show_cover: false, sub_kits: list);
}
...
List<ProTheme> getFlutterFxAnimationList() {
  List<ProTheme> list = [];
