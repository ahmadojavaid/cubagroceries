...
class BestOfNails extends StatelessWidget {
  const BestOfNails({super.key});
    ...
    return Column(
      children: [
        Padding(
          ...
          child: titleRowWidget("Best Of Nails", ""),
        ),
        SizedBox(height: 16),
        SizedBox(
          height: 132,
          child: ListView.builder(
            ...
            itemCount: nailList.length,
            itemBuilder: (context, index) {
              CategoryModel nail = nailList[index];
              return Padding(
                padding: EdgeInsets.only(
                    left: index == 0 ? 24 : 8,
                    right: index == (nailList.length - 1) ? 24 : 8),
                child: Container(
                  height: 132,
                  width: 113,
