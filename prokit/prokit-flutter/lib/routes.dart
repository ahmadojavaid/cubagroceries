...
Map<String, WidgetBuilder> routes() {
  return <String, WidgetBuilder>{
    ...
    ProKitLauncher.flutterFxAnimationsTag: (context) => ProKitLauncher(route: ProKitLauncher.flutterFxAnimationsTag),
    ...
    AthletoSplashScreen.tag: (context) => AthletoSplashScreen(),
    StayNestSplashScreen.tag: (context) => StayNestSplashScreen(),
    VillaVerseSplashScreen.tag: (context) => VillaVerseSplashScreen(),
    ...
    Material3Screen.tag: (context) => Material3Screen(),
    CarouselViewSliderScreen.tag: (context) => CarouselViewSliderScreen(isDirect: true),
    WaterFxEffectScreen.tag: (context) => WaterFxEffectScreen(isDirect: true),
    CircleSelectorHomeWidget.tag: (context) => CircleSelectorHomeWidget(isDirect: true),
    BlurFadeExample.tag: (context) => BlurFadeExample(isDirect: true),
    BorderBeamHomeScreen.tag: (context) => BorderBeamHomeScreen(isDirect: true),
    NeonGradientCardDemoScreen.tag: (context) => NeonGradientCardDemoScreen(isDirect: true),
    TextRotateDemoScreen.tag: (context) => TextRotateDemoScreen(isDirect: true),
    Tech3dCloudStackDemoScreen.tag: (context) => Tech3dCloudStackDemoScreen(isDirect: true),
